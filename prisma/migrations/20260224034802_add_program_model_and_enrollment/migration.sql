-- AlterTable
ALTER TABLE `material` ADD COLUMN `programId` VARCHAR(191) NULL;
...
-- CreateIndex
CREATE INDEX `Material_programId_fkey` ON `material`(`programId`);
...
-- AddForeignKey
ALTER TABLE `material` ADD CONSTRAINT `Material_programId_fkey` FOREIGN KEY (`programId`) REFERENCES `programs`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
