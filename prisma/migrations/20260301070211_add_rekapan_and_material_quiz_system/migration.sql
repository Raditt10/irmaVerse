...
-- AddForeignKey
ALTER TABLE `rekapan` ADD CONSTRAINT `rekapan_materialId_fkey` FOREIGN KEY (`materialId`) REFERENCES `material`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `material_quizzes` ADD CONSTRAINT `material_quizzes_materialId_fkey` FOREIGN KEY (`materialId`) REFERENCES `material`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
