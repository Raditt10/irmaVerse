...
const OurPrograms = () => {
  ...
  const confirmDeleteProgram = async () => {
    ...
    try {
      // For mock data, delete directly from state
      // In production, this would call: DELETE /api/programs/{id}
      ...
      setNotification({
        type: "error",
        title: "Gagal!",
        message: error.message || "Terjadi kesalahan saat menghapus program",
      });
    }
  };
        ...
        <div className="flex-1 w-full max-w-[100vw] overflow-x-hidden px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8 lg:mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              {/* Quick Stats (Hidden on very small screens if crowded) */}
              <div className="hidden sm:flex flex-wrap gap-2 text-xs font-bold">
              ...
              <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    ...
                    <ChevronDown 
                      className={`h-5 w-5 text-slate-400 shrink-0 transition-transform duration-300 ${isDropdownOpen ? 'rotate-180 text-teal-500' : ''}`} 
                      strokeWidth={3} 
                    />
                  </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                  {filteredPrograms.map((program) => {
                    const statusMeta: Record<Program["status"], { label: string; icon: any; color: string; bg: string; border: string }> = {
                      "in-progress": { label: "Berlangsung", icon: Clock3, color: "text-amber-700", bg: "bg-amber-100", border: "border-amber-200" },
                      done: { label: "Selesai", icon: CheckCircle2, color: "text-emerald-700", bg: "bg-emerald-100", border: "border-emerald-200" },
                      upcoming: { label: "Mendatang", icon: Hourglass, color: "text-blue-700", bg: "bg-blue-100", border: "border-blue-200" }
                    };
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative h-48 sm:h-52 overflow-hidden border-b-2 border-slate-100">
                          ...
                          <div className={`absolute top-4 right-4 px-3 py-1 rounded-full flex items-center gap-1.5 border-2 shadow-sm ${meta.bg} ${meta.border}`}>
                        ...
                        <div className="p-6 flex flex-col justify-between flex-1">
                          ...
                          <DetailButton
                            ...
                            onEdit={() => router.push(`/programs/${program.id}/edit`)}
