    ...
    <div className="relative w-full">
      ...
      >
        <span className="flex items-center gap-2">
          ...
          {formatDisplayTime(value.replace(".", ":"))}
        </span>
      </button>
      ...
      {isOpen && (
        <div className="fixed md:absolute bottom-0 md:bottom-full md:left-0 md:mb-2 z-50 bg-white rounded-t-3xl md:rounded-3xl border-4 border-slate-300 shadow-[0_8px_16px_rgba(0,0,0,0.1)] p-4 w-full md:max-w-sm md:w-auto inset-x-0 md:inset-auto md:mt-0">
          <div className="absolute inset-0 bg-white/50 backdrop-blur-sm -z-10 rounded-3xl md:hidden" onClick={() => setIsOpen(false)} />
          {/* Header */}
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-linear-to-br from-teal-50 to-cyan-50 border-4 border-teal-300 rounded-2xl px-6 py-4 min-w-28 text-center">
                <input
                  type="number"
                  min="0"
                  max="23"
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-linear-to-br from-cyan-50 to-teal-50 border-4 border-cyan-300 rounded-2xl px-6 py-4 min-w-28 text-center">
                <input
                  type="number"
                  min="0"
                  max="59"
          ...
          {/* Time Display */}
          <div className="text-center p-3 bg-linear-to-r from-teal-100 to-cyan-100 rounded-2xl border-2 border-teal-300 mt-4 mb-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-teal-400 text-white font-black text-sm rounded-xl border-2 border-teal-600 shadow-[0_4px_0_0_#0f766e] hover:bg-teal-500 transition-all active:translate-y-0.5 active:shadow-none"
            >
              Pilih
            </button>
          </div>
